        ...
        public override void AI()
        {
            ...
            for (int i = minTileX; i <= maxTileX; i++)
            {
                for (int j = minTileY; j <= maxTileY; j++)
                {
                    ...
                    {
                        if (Main.tileDungeon[Main.tile[i, j].TileType] || Main.tile[i, j].TileType == 88 ||
                            Main.tile[i, j].TileType == 21 || Main.tile[i, j].TileType == 26 ||
                            Main.tile[i, j].TileType == 107 || Main.tile[i, j].TileType == 108 ||
                            Main.tile[i, j].TileType == 111 || Main.tile[i, j].TileType == 226 ||
                            Main.tile[i, j].TileType == 237 || Main.tile[i, j].TileType == 221 ||
                            Main.tile[i, j].TileType == 222 || Main.tile[i, j].TileType == 223 ||
                        ...
                        if (canKillTile)
                        {
                            ...
                            if (Main.tile[i, j].IsActuated && Main.netMode != 0)
                            {
