...
public override void AI()
        ...
        public override void Kill(int timeLeft)
		{
			...
			for (i = 0; i < shootNum;i++ )
			{
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, new Vector2(baseSpeed*(float)Math.Sin(offsetAngle), baseSpeed*(float)Math.Cos(offsetAngle)), ModContent.ProjectileType<BitterEnd2>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
			}
